/* ═══════════════════════════════════════════════════════════════
   7. NAVIGAZIONE
   ═══════════════════════════════════════════════════════════════ */
const pages=["punto","oggi","piano","spesa","sport","comestai","storico","io","sistema","regole","tools","guida","nuvia","setup","benvenuto","onb2","piani"];let cur="oggi";
...
function show(p){
  ...
  if(!S.onboard.done&&p!=="benvenuto"&&p!=="onb2")p=onb2Attivo()?"onb2":"benvenuto";
...
const ALTRE=[["piano","Piano","piano"],["comestai","Come stai","heart"],["storico","Numeri","progressi"],
             ...
             ["io","Profilo","io"],["sistema","Sistema","gear"],["guida","Guida","guida"],["nuvia","Nuvia","nuvia"]];
/* ═══ L'ASSISTENTE ══════════════════════════════════════════════════
...
const NOTIF_LIV=[["poche","Poche","Solo mattina e sera · 2 al giorno"],
                 ["normale","Normali",tr("Anche il pomeriggio · 3-4 al giorno")],
                 ["tutte","Tutte",tr("Anche ogni pasto · fino a 6")]];
function notifCfg(){
...
const DENS_COSA={
  base:[tr("I pasti e le spunte"),tr("La spesa"),tr("Il peso e l'andamento"),
        ...
        "Acqua e allenamenti","L'assistente"],
