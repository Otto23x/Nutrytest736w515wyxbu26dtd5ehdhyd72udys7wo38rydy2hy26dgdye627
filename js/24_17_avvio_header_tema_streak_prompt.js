...
function render(p){
  ...
  comestai:renderComeStai,storico:renderStorico,io:renderIo,sistema:renderSistema,regole:renderRegole,tools:renderTools,benvenuto:renderBenvenuto,onb2:renderOnb2,piani:renderPiani,guida:renderGuida,nuvia:renderNuvia,setup:renderSetup};
...
setTimeout(()=>{try{qPlanPrecompute();}catch(e){}},4000);
let _rvObs=null;
...
(function(){
  ...
  function showBanner(){
    ...
    b.innerHTML='<img alt="" src="data:image/png;base64," style="width:42px;height:42px;border-radius:12px;border:1px solid var(--linea,#E3EAE8);flex:0 0 auto">'+
      ...
      '<button id="install-yes" style="background:var(--azione,#0C7C74);color:#fff;border:0;border-radius:12px;padding:8px 16px;font-weight:700;font-size:13px;cursor:pointer">Installa</button>'+
